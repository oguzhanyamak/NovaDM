...
This sprint implements a global bandwidth limiter for NovaDM.
...
3. **API** - Added `set_bandwidth_limit` command

### Frontend

No changes required. The bandwidth limiter is transparent to the frontend.
